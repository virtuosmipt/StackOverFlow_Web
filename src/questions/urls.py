...
urlpatterns = [
    ...
    url(r'^question/$', TemplateView.as_view(template_name="question.html")),
    ...
    url(r'^last_questions^/$',TemplateView.as_view(template_name="last_questions.html"),name='last_questions'),
]
